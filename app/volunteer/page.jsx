    ...
    <main className={styles.main}>
      ...
      <div className={styles.container}>
        <header className={`${styles.header} animate-on-scroll`}>
          ...
          <p className={styles.description}>Browse open opportunities now. Sign in for saved signups and approved hour credit history.</p>
          {!user && <p className={styles.loginNotice}>Sign in to track hours and submit listings.</p>}
        </header>
