  ...
  return (
    <main className="min-h-screen bg-ash flex items-center justify-center px-6">
      <div className="relative flex flex-col items-center gap-6 animate-fade-in-soft">
        ...
        <div className="absolute w-36 h-36 rounded-full bg-ember/20 animate-glow-shift animate-delay-600" />
        ...
        <div className="relative z-10 flex items-center gap-2 rounded-2xl bg-soil/70 border border-wheat/15 px-5 py-4 shadow-card">
          ...
          <span className="h-2.5 w-2.5 rounded-full bg-ember animate-pulse animate-delay-160" />
          <span className="h-2.5 w-2.5 rounded-full bg-wheat/80 animate-pulse animate-delay-320" />
        </div>
        ...
        <p className="relative z-10 text-wheat/75 font-mono text-xs tracking-wide-em uppercase">
          Loading FarmBridge
        </p>
      </div>
    </main>
