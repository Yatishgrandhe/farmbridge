  ...
  return (
    <main className={styles.main}>
      <section className={`${styles.card} ${styles.wideCard}`}>
        ...
        <p className={styles.subtitle}>Set up access for personalized eligibility, alerts, and tracker tools.</p>
        <form className={`${styles.form} ${styles.grid}`} onSubmit={onSubmit}>
          ...
          <div className={styles.inputGroup}><label className={styles.label}>Email</label><input type="email" name="email" className={styles.input} required /></div>
          <div className={styles.inputGroup}><label className={styles.label}>Password</label><input type="password" name="password" className={styles.input} minLength={8} required /></div>
