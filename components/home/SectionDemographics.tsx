...
export function SectionDemographics() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden border-y border-border bg-surface py-16 sm:py-24">
      ...
      <div className="absolute inset-0 -z-0 bg-surface/90" aria-hidden />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4">
        ...
        >
          <motion.article
            ...
            className="min-w-0 overflow-hidden rounded-2xl border border-border bg-elevated p-5 shadow-sm sm:p-6"
          >
            <div className="mb-4 flex min-w-0 items-center gap-3">
              <div className="h-10 w-10 shrink-0 rounded-full bg-accent" aria-hidden />
              <h3 className="min-w-0 font-heading text-lg font-semibold text-pretty text-primary sm:text-xl">
                Women
              </h3>
            </div>
            ...
            <p className="mt-4 text-pretty text-sm leading-relaxed text-mid">
